...
class LogServiceTest extends TestCase
{
    ...
    public function testWithLogFilterDtoDateFrom()
    {
        $path = './tests/fixtures/log/sample.log';
        $logFilterDto = (new LogFilterDto())
            ->setDateFrom(new \DateTime('2018-07-07 00:00:00'))
        ;
    ...
    public function testWithLogFilterDtoDateTo()
    {
        $path = './tests/fixtures/log/sample.log';
        $logFilterDto = (new LogFilterDto())
            ->setDateTo(new \DateTime('2018-07-07 00:00:00'))
        ;
